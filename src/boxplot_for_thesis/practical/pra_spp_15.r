...
comparison_BoxPlot <- function(all_data) {
    ...
    legend(
        "topleft",                      # position
        legend = c("default ","resilient"),   # labels
...
# output file as pdf
pdf("/home/ryuko/perf_test_ws/src/performance_test/performance_test/helper_scripts/boxplot_for_thesis/practical/pra_spp_15.pdf",width = 25, height =9)            # start rendering graph as "BoxPlot.pdf"
comparison_BoxPlot(all_data)
dev.off()            
