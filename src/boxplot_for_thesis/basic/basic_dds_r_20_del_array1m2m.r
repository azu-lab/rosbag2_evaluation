...
data4 <- cbind(d1,d2,d3,d4,d5,d6,d9,d10,d11)
...
xaxis_scale <- c('Array_1KB','Array_4KB','Array_16KB','Array_32KB','Array_64KB','Array_256KB','Struct_256B','Struct_4KB','Struct_32KB')
...
comparison_BoxPlot <- function(all_data) {
    ...
    ## draw vertical line
    abline(
        v = c(6, 10, 14, 18, 22, 26, 30, 34), # position
        lwd = 1                       # line width
    )
    ## draw boxplot
    for (i in 1:4){
...
# output file as pdf
pdf("/home/ryuko/perf_test_ws/src/performance_test/performance_test/helper_scripts/boxplot_for_thesis/basic/basic_dds_r_20_del_array1m2m.pdf",width = 25, height =9)            # start rendering graph as "BoxPlot.pdf"
comparison_BoxPlot(all_data)
dev.off()           
