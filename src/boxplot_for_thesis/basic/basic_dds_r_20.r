...
comparison_BoxPlot <- function(all_data) {
    ...
    plot(
        ...
        ylim = c(-10.5, 10.5), # y-axis data span
...
# output file as pdf
pdf("/home/ryuko/perf_test_ws/src/performance_test/performance_test/helper_scripts/boxplot_for_thesis/basic/basic_dds_r_20.pdf",width = 25, height =9)            # start rendering graph as "BoxPlot.pdf"
comparison_BoxPlot(all_data)
dev.off()           
